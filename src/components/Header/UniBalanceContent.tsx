...
import tokenLogo from '../../assets/images/bestswap-logo-single.png'
  ...
  return (
    <ContentWrapper gap="lg">
      <ModalUpper>
        ...
        <CardSection gap="md">
          <RowBetween>
            <TYPE.white color="white">{t('yourBestBreakdown')}</TYPE.white>
        ...
        {account && (
          <>
            <CardSection gap="sm">
              ...
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white color="white">{t('balanceTitle')}:</TYPE.white>
        ...
        <CardSection gap="sm">
          <AutoColumn gap="md">
            <RowBetween>
              <TYPE.white color="white">BEST {t('price')}:</TYPE.white>
              <TYPE.white color="white">${uniPrice?.toFixed(2) ?? '-'}</TYPE.white>
            </RowBetween>
            <RowBetween>
              <TYPE.white color="white">BEST in {t('circulation')}:</TYPE.white>
            ...
            {uni && uni.chainId === ChainId.MAINNET ? (
              <ExternalLink href={`https://uniswap.info/token/${uni.address}`}>{t('viewBestAnalytics')}</ExternalLink>
            ) : null}
          </AutoColumn>
        </CardSection>
      </ModalUpper>
