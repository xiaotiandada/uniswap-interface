        ...
        <LoadingView onDismiss={wrappedOndismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            <TYPE.body fontSize={20}>
              {t('withdrawing')} {stakingInfo?.stakedAmount?.toSignificant(4)} BEST-V2
            </TYPE.body>
            <TYPE.body fontSize={20}>
              {t('claiming')} {stakingInfo?.earnedAmount?.toSignificant(4)} BEST
            </TYPE.body>
          </AutoColumn>
        </LoadingView>
      )}
      {hash && (
        <SubmittedView onDismiss={wrappedOndismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>{t('withdrew')} BEST-V2!</TYPE.body>
