...
export default function AddLiquidity({
  ...
  const modalHeader = () => {
    return noLiquidity ? (
      <AutoColumn gap="20px">
        <LightCard mt="20px" borderRadius="6px">
          <RowFlat>
      ...
      <AutoColumn gap="20px">
        ...
        <TYPE.italic fontSize={12} textAlign="left" padding={'8px 0 0 0 '}>
          {t('output-is-estimated-if-the-price-changes-by-more-than-percentage-your-transaction-will-revert', {
            percentage: (allowedSlippage / 100).toString()
          })}
        </TYPE.italic>
      </AutoColumn>
    )
        ...
        <Wrapper>
          ...
          <AutoColumn gap="20px">
            ...
            {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
              <>
                <LightCard padding="0px" borderRadius={'6px'}>
                  <RowBetween padding="1rem">
                    <TYPE.subHeader fontWeight={500} fontSize={14}>
                      {noLiquidity ? t('initialPrices') : t('prices')} {t('andPoolShare')}
                    </TYPE.subHeader>
                  </RowBetween>{' '}
                  <LightCard padding="1rem" borderRadius={'6px'}>
                    <PoolPriceBar
                      currencies={currencies}
                      poolTokenPercentage={poolTokenPercentage}
                      noLiquidity={noLiquidity}
